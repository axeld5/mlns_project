'''
By calling "run" with the necessary hyperparameters, one can reproduce the results given in the article 
"Predict then Propagate: Graph Neural Networks meet Personalized PageRank".
To achieve this, the code from their models should first be downloaded at https://github.com/gasteigerjo/ppnp
'''
