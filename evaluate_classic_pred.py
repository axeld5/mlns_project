...
if __name__ == "__main__":
    ...
    train_features, test_features, train_labels, test_labels = train_test_split(features, label_list)
    comm_pred = feature_prediction(train_features, train_labels, test_features)
    print("node and global features based classifier accuracy score =", accuracy_score(test_labels, comm_pred))
    ...
    print("community based classifier accuracy score =", accuracy_score(test_labels, comm_pred))
    ...
    print("node2vec embeddings based classifier accuracy score =", accuracy_score(test_labels, node2pred))